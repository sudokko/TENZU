...
68項目の時系列ログ。**今の正**を知るだけなら下の背骨だけ読めばよい。それ以外の項目は後続の判断に上書きされた経緯の記録。
...
| タスクラダー現行 | 模写 §3.55／欠け補完 §3.58／鏡 §3.59／立体 §3.57／平行移動 §3.66／回転 §3.67／かぶり除外 §3.60（公開 copy）・§3.68（兄弟巻） |
...
- 初期ラダー確定群（§3.1〜§3.16・2026-04）→ §3.54〜§3.60・§3.66〜§3.68 の再校正・再構成で上書き
