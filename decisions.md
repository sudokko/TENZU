...
| **総 SKU＝45**（陳列・外向け表示）／**開店ゲート G2 の検品分母＝42**（立体 Lv.5 Vol.2-4 のみ開店後枠） | §3.102（§3.88 の 40 を上書き）＋§3.106（模写 8×8 追加で 44→45・G2 41→42） |
...
> ⚠️ **この § の数字は §3.106 が上書き済み＝陳列 45 巻・全巻制覇 ¥9,000・G2 分母 42 巻**（模写 8×8 Vol.3 を追加し、同日 publish したので開店前の分母に入る）。開店後枠は立体 Lv.5 Vol.2〜4 の 3 巻だけ。参照するときは §3.106 を見ること。
