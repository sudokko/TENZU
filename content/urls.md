...
#### 3.2 P1 配下 — C1-6 のみ記事（2026-07-23 追加）・他は非記事へ降格（2026-06-03）

| # | 仮タイトル | スラッグ |
|---|---|---|
| **C1-6** | 点図形と小学校受験 | `/point-drawing-elementary-exam/` |

C1-2〜C1-5 の記事スラッグは発行しない。下記は移譲先。
...
| **C3-6** | 図形模写 とは／点図形 違い（VOL 未計測・2026-07-18 新設） | **`/figure-copy-vs-point-drawing/`** | **記事・cluster-compare（LLMO 主目的）** |

#### 3.5 P4 配下（記事 3 本＋カテゴリLP／LP）
