...
- SEO・UI・メンテの3観点を統合
- 段階的公開: Phase 2 M2b で long 2本／Phase 3 で long 個別 2本追加 ＋ 集約ページ完成
...
## §8. 段階別公開計画（3 フェーズ対応・2026-05-28 統合反映）

| フェーズ | 公開するFAQ | 想定本数 |
|---|---|---|
| **Phase 1**（仕込み） | なし（販売してないFAQは違和感） | 0 |
| **Phase 2 M2a**（先行リリース前半） | 個別FAQ（long）2本：#59 商業利用・#60 教室利用 | 2 |
| **Phase 2 M2b**（先行リリース後半） | + 個別 FAQ（long）2 本：#64・#65 | +2 |
| **Phase 3**（本リリース） | 個別FAQ（long）4本（#59/#60/#64/#65）＋ `/faq/` 集約ページ完成 | 4＋集約 |
| **Phase 3 以降 運用** | 月次2-4本ペース（モニター/サポートQAから抽出） | 月+2-4 |
