...
- **ロゴ**: 鉛筆筆致版 canonical（Symbol = 4-dot floating ／ Wordmark = Ξ-form E）。マスター原本は `logodesign/`、配信用は `../web/public/assets/`。**屋号 SUDO CRAFT は別系統のビジュアル**（マスコット＋丸ゴシック Wordmark・別パレット・用途＝SNS 3 アカウント/屋号ページ/法務表記／visual-identity §5.4）
