...
- **Design System rev.5**: 純白 `#FFFFFF` ＋ 点格子（24/28px・opacity 0.16）／ 3 階層フォント（Klee One 600 ① ・ Zen Kurenaido ② ・ Plex Sans JP & Mono ③）／ 罫線 4 種のみ・shadow ほぼ無し・静的既定／ accent `#2C6E7F` は「到達・正解」限定
...
| タイポ | 3 階層: Klee One 600（見出し・プロミス）／ Zen Kurenaido（温度コピー・メモ）／ Plex Sans JP & Mono（UI・数値・長文） |
...
| 記事 | `../web/app/articles/` |
| おためし点描写メーカー | `../web/app/maker/`（仕様: [../product/pack-design.md §23](../product/pack-design.md)・[../foundation/brand.md §11.3.1](../foundation/brand.md)） |
