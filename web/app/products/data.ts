    ...
    vols: [
      {
        ...
        meate: "見本の図形には線が何本か足りていません。完成形を思いうかべながら「どこが欠けているか」を見つけ出し、足りない線をおぎなって形を仕上げます。3×3のやさしい形で、全体から欠けを見抜く——『見て写す』とは逆向きに、推理するように見る目の第一歩を育てます。",
      },
      {
        ...v("fill-lv2-vol1", 2, 1, "3×3", "ナナメ線が入った形の続きを描こう。3×3でじっくり。", "4〜6才ごろ", "live"),
        meate: "欠けた形にナナメの線が加わります。たて・よこだけのときよりも「どの向きの線が足りないのか」がつかみにくくなり、形の対称性やバランスを手がかりに欠けを推理します。3×3のまま、傾いた線の欠けを見抜く目をじっくり養います。",
      },
      {
        ...v("fill-lv3-vol1", 3, 1, "4×4", "4×4で線が増えて交差も。欠け少なめで型をつかむ。", "5〜7才ごろ", "live", "欠け少なめ"),
        meate: "盤面が4×4に広がり、線の交差も現れます。欠けはまだ少なめなので、残っている線を手がかりに「足りない一本」を落ち着いて特定し、補完の型をつかむ巻です。複雑になった形でも、全体像から欠けを逆算する見方に慣れていきます。",
      },
      {
        ...v("fill-lv3-vol2", 3, 2, "4×4", "同じ4×4で欠けが多めに。全体像を推測する力が育つ。", "5〜8才ごろ", "live", "欠け多め"),
        meate: "同じ4×4でも、欠けている線がぐっと増えます。残った手がかりが少ない中で、わずかな線と形の対称性から「完成形はどんな図か」を大胆に推測し、まとめて補う力が問われます。部分から全体を思い描く、推理の力がぐっと伸びる巻です。",
      },
      {
        ...v("fill-lv4-vol1", 4, 1, "5×5", "5×5・ナナメ入り。広い盤面で欠け少なめ。", "6〜8才ごろ", "live", "欠け少なめ"),
        meate: "5×5の広い盤面にナナメの線が組み合わさります。欠けは少なめでも、線の数が増えたぶん「どこが抜けているか」の見落としが起きやすくなります。広い面を端から端まで見渡し、欠けを取りこぼさず補完しきる注意力と全体把握力を養います。",
      },
      {
        ...v("fill-lv4-vol2", 4, 2, "5×5", "5×5で欠けが多め。空間認知の応用力を試す。", "6〜9才ごろ", "live", "欠け多め"),
        meate: "5×5で欠けが多めに。複雑な形の多くの部分が抜けた状態から、残った線と対称性だけを頼りに完成形を組み立て直します。部分の情報から全体を復元する——空間認知の応用力をしっかり試す巻です。",
      },
      {
        ...v("fill-lv5-vol1", 5, 1, "6×6", "6×6に拡大。最大盤面で欠け少なめから。", "8才〜", "live", "欠け少なめ"),
        meate: "最大盤面の6×6へ。広く線も多い形ですが、欠けは少なめなので、まずは大きな面の中で欠けを正確に見つけ切ることに集中します。情報量の多い図形でも一本の欠けを見逃さない、補完の総仕上げに向けた目を鍛えます。",
      },
      {
        ...v("fill-lv5-vol2", 5, 2, "6×6", "6×6で欠け最大。補完マスターへ。", "8才〜", "live", "欠け多め"),
        meate: "6×6で欠けが最大に。最も広い盤面で、形の大半が欠けた状態から完成形を推理して描き起こす、欠け補完の最終巻です。限られた手がかりから全体像を確信を持って描ききる、推理と再現の力を完成させます。",
      },
    ],
  },
  /* ============ B. かたちを動かす ============ */
    ...
    vols: [
      {
        ...
        meate: "まん中のたての線を境にして、見本を左右にパタンと折り返した「鏡うつし」を描きます。右にある点が、軸からおなじ距離だけ左のどこへ移るか——位置を“裏返して”考える、点描写とはひと味ちがう空間の操作にはじめて挑戦します。3×3でその感覚をじっくりつかみます。",
      },
      {
        ...v("mirror-lv3-vol1", 3, 1, "4×4", "線が増えて交差も登場。縦の鏡うつしを4×4でしっかり。", "5〜7才ごろ", "live", "縦軸"),
        meate: "たての鏡うつしを4×4へ。線が増えて交差も現れ、裏返す線の本数も多くなります。一本ずつ「軸の向こう側のどこへ移るか」を正確に対応させ、複雑な形でも左右対称に写しとる力を養います。縦の反転をしっかり手の内に入れる巻です。",
      },
      {
        ...v("mirror-lv4-vol1", 4, 1, "3×3", "横の鏡デビュー。水面にうつる景色のように、上下を返す目を育てる。", "6〜8才ごろ", "live", "横軸"),
        meate: "こんどは軸が横向きに。よこの線を境に、上下をパタンと返した形を描きます。水面にうつる景色のように、上にあるものが下へ——たて軸とはちがう「上下の反転」に頭を切りかえる練習です。3×3のやさしい形で、横の鏡の感覚をつかみます。",
      },
      {
        ...v("mirror-lv4-vol2", 4, 2, "4×4", "横の鏡うつしも4×4へ。広い盤面でも落ち着いて。", "6〜9才ごろ", "live", "横軸"),
        meate: "よこの鏡うつしを4×4へ。盤面が広がり線も増える中で、上下の反転を落ち着いて正確に行います。「上から数えていくつ目の点は、下から数えていくつ目へ移る」という対応づけを、より複雑な形でも崩さずやりきる力を育てます。",
      },
      {
        ...v("mirror-lv5-vol1", 5, 1, "3×3", "ナナメの鏡デビュー。日常にない方向の反転に挑戦。", "8才〜", "live", "斜め軸"),
        meate: "いちばん難しい、ななめの軸での鏡うつしに挑戦します。斜めの線を境に折り返すと、たて・よこの位置が入れかわるように移り、日常ではあまり出会わない向きの反転になります。3×3で、頭の中で図形を斜めにひっくり返す高度な空間操作の第一歩を踏み出します。",
      },
      {
        ...v("mirror-lv5-vol2", 5, 2, "4×4", "ナナメの鏡うつしも4×4へ。空間操作の力をつける。", "8才〜", "live", "斜め軸"),
        meate: "ななめの鏡うつしを4×4へ。最も直感が効きにくい斜め軸の反転を、線の増えた複雑な形で正確にやりきります。頭の中で図形を回しながら裏返す——空間を自在に操作する力の総仕上げとなる、鏡タスクの最終巻です。",
      },
    ],
  },
  {
