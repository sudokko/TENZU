...
export const PRODUCT_TASKS: ProductTask[] = [
  ...
  },
  {
    /* 立体（斜投影＝キャビネット図・矩形点格子）。旧「ブロック数」は廃止・2026-07-01 ゼロベース再設計。
       巻＝難易度（Lv.3・Lv.4＝小さめの形で見える辺だけ／Lv.5 Vol.1＝**大きい形を見える辺だけ**／
       Lv.5 Vol.2＝隠れ辺フル）／中身は形カタログの混合。各巻に立方体・直方体・L字・階段・家・門・
       塔・複合・中庭・柱廊・街並み 等を混ぜる（decisions §3.57・§3.108）。 */
    ...
    vols: [
      ...
      {
        ...v("solid-lv5-vol1", 5, 1, "大きい立体", "二棟・基壇・門・中庭・柱廊。広い盤面いっぱいの大きな立体を、見える辺だけで写す。", "7才〜", "見える辺だけ・大型"),
        meate: "基礎・応用より一段大きい立体を写します。描くのは見える辺だけですが、盤面が広がるぶん線の数が増え、どこから写しはじめてどの順に進めるかを自分で決める必要が出てきます。二棟・基壇・門・中庭・柱廊——形の種類もぐっと増えるので、「何が組み合わさってできているか」を先に読み取ってから写す力を育てる巻です。",
      },
      {
        ...v("solid-lv5-vol2", 5, 2, "錐・空洞・複合", "四角錐・空洞・大階段・塔・複合建築。隠れ辺をすべて点線で写す発展編。", "7才〜", "隠れ辺フル・5かたち"),
        meate: "見えない辺（隠れ辺）を点線で写す、立体模写の最終巻です。手前の面にさえぎられて見えない奥の稜線を、見えている辺から推し量って引きます。目に映るものを写すのではなく、立体の構造そのものを頭の中で組み立ててから紙に落とす——空間認知の土台がいちばん強く働く巻です。",
      },
    ],
  },
  {
