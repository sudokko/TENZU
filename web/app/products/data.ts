...
export const PRODUCT_TASKS: ProductTask[] = [
  /* ============ A. 見て写す ============ */
  {
    ...
    vols: [
      {
        ...v("copy-lv1-vol1", 1, 1, "3×3", "はじめての点描写に。点と点を結ぶ「まっすぐ」から。", "3〜6才ごろ", "live"),
      ...
      {
        ...v("copy-lv5-vol1", 5, 1, "6×6", "発展編のはじまり。広い6×6で、複雑なかたちに挑む。", "7才〜", "live"),
      ...
      {
        ...v("copy-lv5-vol2", 5, 2, "7×7", "最大盤面7×7。大人でも手ごたえの、点描写マスターへ。", "7才〜", "live"),
  ...
  },
  {
    ...
    vols: [
      ...
      v("solid-lv5-vol1", 5, 1, "錐・空洞・複合", "四角錐・空洞・大階段・塔・複合建築。隠れ辺をすべて点線で写す発展編。", "7才〜", "scaffold", "隠れ辺フル・5かたち"),
    ],
  },
  {
    ...
    vols: [
      ...
      {
        ...v("fill-lv5-vol1", 5, 1, "6×6", "最大6×6・欠け4〜6本。全体像を復元する総仕上げ。", "7才〜", "live", "欠け4〜6本"),
  ...
  /* ============ B. かたちを動かす ============ */
  {
    ...
    vols: [
      ...
      {
        ...v("mirror-lv5-vol1", 5, 1, "6×6", "最大6×6。複雑な形の鏡うつし、総仕上げ。", "7才〜", "live"),
  ...
  /* ============ C. 重ねる・分ける ============ */
  {
    ...
    vols: [
      ...
      v("overlay-lv5-vol1", 5, 1, "6×6", "6×6・絡み最大。かさねマスターへ。", "7才〜", "scaffold"),
    ],
  },
  {
    ...
    vols: [
      ...
      v("decompose-lv5-vol1", 5, 1, "6×6", "6×6・絡み最大。密な重なりから取り出す、分解マスターへ。", "7才〜", "scaffold"),
    ],
  },
  {
    ...
    vols: [
      ...
      v("fold-lv5-vol1", 5, 1, "6×6", "6×6・絡み最大。折り重ねマスターへ。", "7才〜", "scaffold"),
    ],
  },
];
