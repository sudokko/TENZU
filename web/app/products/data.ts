...
export const PRODUCT_TASKS: ProductTask[] = [
  ...
  },
  {
    ...
    vols: [
      ...
      {
        /* 説明の形の列挙は published の実物に合わせる（2026-08-14 監査）。旧文は
           大階段・塔・複合建築を挙げていたが、収録 12 問にその 3 つが無かった。
           点線の本数は問題を入れ替えるとズレるので、数を書かず「増えていく」で言う。 */
        ...v("solid-lv5-vol2", 5, 2, "錐・空洞・複合", "三角錐・四角錐・空洞・門・大きな複合立体。隠れ辺の少ない形からはじめて、点線が増えていく発展編。", "7才〜", "隠れ辺フル・錐から複合へ"),
