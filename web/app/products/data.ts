...
export const PRODUCT_TASKS: ProductTask[] = [
  /* ============ A. 見て写す ============ */
  {
    ...
    vols: [
      ...
      {
        ...v("copy-lv5-vol2", 5, 2, "7×7", "最大盤面7×7。大人でも手ごたえの、点描写マスターへ。", "7才〜"),
  ...
  },
  {
    ...
    vols: [
      ...
      v("solid-lv4-vol1", 4, 1, "組む・柱・屋根", "段差・三角柱・家・門・小さな錐。うしろに隠れる辺を点線で少しずつ。", "6〜9才ごろ", "隠れ辺すこし・5かたち"),
  ...
  },
  {
    ...
    vols: [
      ...
      {
        ...v("translate-lv5-vol1", 5, 1, "6×6", "最大6×6。複数方向の移動を、広い盤面で組み合わせる総仕上げ。", "7才〜", "複合"),
  ...
  },
  {
    ...
    vols: [
      ...
      {
        ...v("rotate-lv4-vol2", 4, 2, "4×4", "180°デビュー。さかさまの世界を、4×4で読み解く。", "6〜9才ごろ", "180°"),
  ...
  /* ============ C. 重ねる・分ける ============ */
  {
    ...
    vols: [
      ...
      v("overlay-lv4-vol1", 4, 1, "5×5", "45°じゃないナナメが初登場。絡みはひかえめに、めずらしい角度に集中。", "6〜9才ごろ"),
  ...
  },
  {
    ...
    vols: [
      ...
      v("decompose-lv3-vol1", 3, 1, "4×4", "4×4・ナナメも交差も登場。少ない絡みから「引き算思考」を育てる。", "5〜8才ごろ"),
      v("decompose-lv4-vol1", 4, 1, "5×5", "45°じゃないナナメが初登場。めずらしい角度の線を、正しく引き分ける。", "6〜9才ごろ"),
      v("decompose-lv5-vol1", 5, 1, "6×6", "6×6・絡み最大。密な重なりから取り出す、分解マスターへ。", "7才〜"),
    ],
  },
  {
    ...
    vols: [
      ...
      v("fold-lv3-vol1", 3, 1, "4×4", "4×4・ナナメも交差も登場。絡みはひかえめに、折り返しの型をつかむ。", "5〜8才ごろ"),
      v("fold-lv4-vol1", 4, 1, "5×5", "45°じゃないナナメが初登場。めずらしい角度を、折り返して重ねる。", "6〜9才ごろ"),
      v("fold-lv5-vol1", 5, 1, "6×6", "6×6・絡み最大。折り重ねマスターへ。", "7才〜"),
    ],
  },
];
