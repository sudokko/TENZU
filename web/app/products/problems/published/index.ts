...
import j8 from "./fill-lv2-vol1.json";
import j9 from "./fill-lv3-vol1.json";
import j10 from "./fill-lv4-vol1.json";
import j11 from "./fill-lv5-vol1.json";
import j12 from "./mirror-lv2-vol1.json";
import j13 from "./mirror-lv3-vol1.json";
...
export const PUBLISHED: Record<string, SkuProblemSet> = {
  ...
  "fill-lv2-vol1": j8 as unknown as SkuProblemSet,
  "fill-lv3-vol1": j9 as unknown as SkuProblemSet,
  "fill-lv4-vol1": j10 as unknown as SkuProblemSet,
  "fill-lv5-vol1": j11 as unknown as SkuProblemSet,
  "mirror-lv2-vol1": j12 as unknown as SkuProblemSet,
  "mirror-lv3-vol1": j13 as unknown as SkuProblemSet,
