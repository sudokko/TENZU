...
import j5 from "./fill-lv2-vol1.json";
import j6 from "./solid-lv3-vol1.json";
...
export const PUBLISHED: Record<string, SkuProblemSet> = {
  ...
  "fill-lv2-vol1": j5 as unknown as SkuProblemSet,
  "solid-lv3-vol1": j6 as unknown as SkuProblemSet,
};
