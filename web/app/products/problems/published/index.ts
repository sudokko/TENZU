...
import j2 from "./copy-lv2-vol2.json";
import j3 from "./copy-lv3-vol1.json";
import j4 from "./copy-lv3-vol2.json";
import j5 from "./copy-lv4-vol1.json";
...
export const PUBLISHED: Record<string, SkuProblemSet> = {
  ...
  "copy-lv2-vol2": j2 as unknown as SkuProblemSet,
  "copy-lv3-vol1": j3 as unknown as SkuProblemSet,
  "copy-lv3-vol2": j4 as unknown as SkuProblemSet,
  "copy-lv4-vol1": j5 as unknown as SkuProblemSet,
};
