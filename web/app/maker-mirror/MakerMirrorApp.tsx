...
export default function MakerMirrorApp() {
  ...
  const rCount = useMemo(() => mirrorEdgesOf(edges, gridSize, axis).length, [edges, gridSize, axis]);
  ...
  const axisLabel = axis === "v" ? "左右反転" : "上下反転";
      ...
      <div className="app-shell">
        ...
        <main className="canvas-area">
          <div className="canvas-gridbar">
            ...
            <span className="gb-label" style={{ marginLeft: "auto" }}>{axisLabel}・解答自動</span>
          </div>
          ...
          <div className="group group--pair-frame"
            ...
            <h3 style={{ margin: "0 0 8px", fontSize: 13 }}>
              ...
              <span style={{ marginLeft: 8, fontSize: 11, color: "#6b727b", fontWeight: "normal" }}>
                {pairLayout === "horizontal" ? "横並び＝左右反転" : "下並び＝上下反転"}
              </span>
            </h3>
